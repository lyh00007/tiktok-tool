...
// @author       @李懿恒
// @match        https://affiliate.tiktokglobalshop.com/connection/target-invitation/edit?invitation_id=*
// @grant        none
// ==/UserScript==
...
(function() {
    ...
    function extractNicknames() {
        // 修改选择器以匹配新的HTML结构
        const nicknameElements = document.querySelectorAll('div.text-neutral-text1.text-body-m-medium.cursor-pointer div.arco-typography');
